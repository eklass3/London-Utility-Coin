...
async function tradeCommodity(trade) {
    ...
    let assetRegistry = await getAssetRegistry('org.london.luc.Commodity');
 ...
 * @param {org.london.luc.RemoveHighQuantityCommodities} remove - the remove to be processed
 * @transaction
 */
async function removeHighQuantityCommodities(remove) {
    ...
    for (let n = 0; n < results.length; n++) {
        ...
        let removeNotification = getFactory().newEvent('org.london.luc','RemoveNotification');
